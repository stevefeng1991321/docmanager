...
:root{--bg:#0f172a;--surface:#1e293b;--border:#334155;--text:#e2e8f0;--muted:#94a3b8;--dim:#64748b;--accent:#0ea5e9;--accent2:#38bdf8;--sidebar:270px}
...
code{background:#0f172a;border:1px solid var(--border);padding:1px 5px;border-radius:4px;font-family:"SFMono-Regular",Consolas,monospace;font-size:.82em;color:#7dd3fc}
...
.nav-item:hover{color:var(--text);background:rgba(14,165,233,.08)}
.nav-item.active{color:#fff;background:rgba(14,165,233,.2);border-right:2px solid var(--accent)}
...
table{width:100%;border-collapse:collapse;font-size:.82rem;margin:1rem 0;overflow-x:auto;display:block}
