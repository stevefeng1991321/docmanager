...
:root{--bg:#0f172a;--surface:#1e293b;--border:#334155;--text:#e2e8f0;--muted:#94a3b8;--dim:#64748b;--accent:#3b82f6;--accent2:#60a5fa;--sidebar:270px}
...
code{background:#0f172a;border:1px solid var(--border);padding:1px 5px;border-radius:4px;font-family:"SFMono-Regular",Consolas,monospace;font-size:.82em;color:#93c5fd}
...
.nav-item.active{color:#fff;background:rgba(59,130,246,.18);border-right:2px solid var(--accent)}
...
blockquote{border-left:3px solid var(--accent);padding:.5rem 1rem;margin:1rem 0;color:var(--muted);font-size:.9rem;background:rgba(59,130,246,.05);border-radius:0 6px 6px 0}
