...
<div x-data="workReportForm({{ \Illuminate\Support\Js::from($initialTasks) }})" class="space-y-5">
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-5">
        ...
        <div class="grid grid-cols-3 gap-5">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Project <span class="text-gray-400">(optional)</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Client <span class="text-gray-400">(optional)</span></label>
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-5">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Tasks Completed</label>
        ...
        <div class="grid grid-cols-2 gap-5">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Challenges / Issues</label>
