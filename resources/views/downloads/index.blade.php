@extends('layouts.app')
@section('title', __('downloads.heading'))

@section('content')
<div class="space-y-4">
    <h1 class="text-xl font-bold text-gray-800">{{ __('downloads.heading') }}</h1>
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm divide-y divide-gray-50">
        ...
        @empty
        <p class="px-5 py-10 text-center text-gray-400 text-sm">{{ __('downloads.empty') }}</p>
        @endforelse
    </div>
