...
@section('content')
<div class="space-y-5">
    <h1 class="text-xl font-bold text-gray-800">Tag: <span class="text-blue-600">{{ $tag->name }}</span></h1>
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm divide-y divide-gray-50">
        ...
        @empty
        <p class="px-5 py-10 text-center text-gray-400 text-sm">No documents with this tag.</p>
        @endforelse
    </div>
