...
@section('title', 'Vite Documentation')
...
<div class="-m-4 sm:-m-6" style="height:calc(100vh - 3.5rem)">
    ...
    @if($available)
        ...
        <iframe src="{{ route('admin.help.vite.doc') }}"
                class="w-full h-full border-0"
                title="Vite Offline Documentation">
        </iframe>
    ...
    @else
        ...
        <div class="flex items-center justify-center h-full bg-gray-50">
            <div class="max-w-lg text-center px-6">
                ...
                <h2 class="text-lg font-semibold text-gray-800 mb-2">Offline Vite docs not found</h2>
                <p class="text-sm text-gray-500 mb-6">
                    The file <code class="bg-gray-100 px-1.5 py-0.5 rounded text-xs font-mono">documentation/vite/index.html</code>
                ...
                <div class="text-left bg-gray-900 text-green-300 rounded-xl px-5 py-4 font-mono text-sm space-y-1 mb-6">
                    <p><span class="text-gray-500"># 1. Download Vite markdown files from GitHub</span></p>
                    <p>php artisan docs:import-vite --branch=main</p>
                    <p class="pt-1"><span class="text-gray-500"># 2. Build the self-contained HTML file</span></p>
                    <p>php artisan docs:build-vite-offline --branch=main</p>
                </div>
