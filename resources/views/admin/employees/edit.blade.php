...
<div class="max-w-3xl mx-auto space-y-5">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-bold text-gray-800">{{ __('admin.employees.edit') }} — {{ $employee->full_name }}</h1>
        <a href="{{ route('admin.employees.show', $employee) }}" class="text-sm text-gray-500 hover:text-gray-700">{{ __('common.back') }}</a>
    </div>
