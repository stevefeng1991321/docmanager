...
<div class="space-y-6" x-data="{ confirmRestore: null, confirmDelete: null }">
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 class="font-semibold text-gray-800">Create Backup</h2>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            <h3 class="font-semibold text-gray-800">Stored Backups</h3>
        ...
        <table class="min-w-full divide-y divide-gray-100 text-sm">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Filename</th>
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-4 py-10 text-center text-gray-400">No backups yet. Create one above.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    {{-- Restore from Upload --}}
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
        <h2 class="font-semibold text-gray-800">Restore from Upload</h2>
    ...
    <div x-show="confirmRestore"
        ...
        <div class="bg-white rounded-xl shadow-xl p-6 max-w-md w-full mx-4"
             @click.stop>
            <h3 class="text-base font-semibold text-gray-800">Confirm Restore</h3>
            <p class="text-sm text-gray-600 mt-2">
                Restore from <span class="font-mono text-xs bg-gray-100 px-1 py-0.5 rounded" x-text="confirmRestore"></span>?
                <br><strong class="text-red-600">All current data will be overwritten.</strong> This cannot be undone.
            </p>
    ...
    <div x-show="confirmDelete"
        ...
        <div class="bg-white rounded-xl shadow-xl p-6 max-w-md w-full mx-4"
             @click.stop>
            <h3 class="text-base font-semibold text-gray-800">Delete Backup</h3>
            <p class="text-sm text-gray-600 mt-2">
                Delete <span class="font-mono text-xs bg-gray-100 px-1 py-0.5 rounded" x-text="confirmDelete"></span>?
