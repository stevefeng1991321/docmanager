...
<div class="max-w-2xl mx-auto space-y-5">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-bold text-gray-800">{{ __('admin.science_tech.edit') }}</h1>
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden"
        ...
        <div class="px-6 py-5 border-t border-gray-100">
            ...
            <form method="POST" action="{{ route('admin.science-tech.media.store', $trend) }}"
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-700 mb-1">Title <span class="text-gray-400 font-normal">(optional)</span></label>
                    <input type="text" name="title" maxlength="255" placeholder="e.g., Lab photo, Experiment video"
                           value="{{ old('title') }}"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
