    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        @empty
            <div class="px-6 py-16 text-center">
                ...
                <button @click="openNewChat()" class="text-sm font-medium text-blue-600 hover:underline">
                    Start a new chat
                </button>
            </div>
        @endforelse
        ...
        <div class="bg-white rounded-xl shadow-xl w-full max-w-md mx-4" @click.outside="showNewChat = false">
            ...
            <div class="p-5 space-y-4">
                ...
                <div class="flex gap-2">
                    <button
                        @click="newChatType = 'private'; selectedUsers = []"
                    ...
                    >Private</button>
                    <button
                        @click="newChatType = 'group'; selectedUsers = []"
