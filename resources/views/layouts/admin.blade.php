                ...
                $groups = [
                    [
                        ...
                        'items' => [
                            ...
                            ['route' => 'chat.index',      'label' => 'Messages',  'icon' => 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z'],
                        ],
                    ],
                    [
                        'label' => 'Content',
            ...
            @foreach ($groups as $group)
                <div>
                    ...
                    @foreach ($group['items'] as $item)
                        ...
                        @if(false) {{-- placeholder removed with chat feature --}}
                        @else
                        {{-- Regular nav item --}}
                        <a href="{{ $itemHref }}"
